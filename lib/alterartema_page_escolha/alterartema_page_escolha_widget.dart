...
import 'alterartema_page_escolha_model.dart';
export 'alterartema_page_escolha_model.dart';

class AlterartemaPageEscolhaWidget extends StatefulWidget {
  const AlterartemaPageEscolhaWidget({
    super.key,
    this.users,
  });
  ...
  static String routeName = 'alterartema_page_escolha';
  static String routePath = 'alterartema';

  @override
  State<AlterartemaPageEscolhaWidget> createState() =>
      _AlterartemaPageEscolhaWidgetState();
}

class _AlterartemaPageEscolhaWidgetState
    extends State<AlterartemaPageEscolhaWidget> {
  late AlterartemaPageEscolhaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AlterartemaPageEscolhaModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'alterartema_page_escolha'});
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    FFButtonWidget(
                                                      onPressed: () async {
                                                        logFirebaseEvent(
                                                            'ALTERARTEMA_ESCOLHA_SAIR_BTN_ON_TAP');
                                                        await authManager
                                                            .refreshUser();
                                                    ...
                                                    FFButtonWidget(
                                                      onPressed: () async {
                                                        logFirebaseEvent(
                                                            'ALTERARTEMA_ESCOLHA_SELECIONAR_BTN_ON_TA');
                                                        await authManager
                                                            .refreshUser();
                                                        if (currentUserEmailVerified ==
                                                            true) {
