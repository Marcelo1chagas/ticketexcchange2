...
import 'status_pagamento_p_i_x_alcance5dias_model.dart';
export 'status_pagamento_p_i_x_alcance5dias_model.dart';

class StatusPagamentoPIXAlcance5diasWidget extends StatefulWidget {
  const StatusPagamentoPIXAlcance5diasWidget({
    super.key,
  ...
  static String routeName = 'statusPagamentoPIXAlcance5dias';
  static String routePath = 'statusPagamentoPIXAlcance5dias';

  @override
  State<StatusPagamentoPIXAlcance5diasWidget> createState() =>
      _StatusPagamentoPIXAlcance5diasWidgetState();
}

class _StatusPagamentoPIXAlcance5diasWidgetState
    extends State<StatusPagamentoPIXAlcance5diasWidget> {
  late StatusPagamentoPIXAlcance5diasModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StatusPagamentoPIXAlcance5diasModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'statusPagamentoPIXAlcance5dias'});
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final statusPagamentoPIXAlcance5diasObterPagamentoPagarMEResponse =
            snapshot.data!;
                                                ...
                                                children: [
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'STATUS_PAGAMENTO_P_I_X_ALCANCE5DIAS_Row_');
                                                        logFirebaseEvent(
                                                          ...
                                                          Align(
                                                            ...
                                                            child:
                                                              ...
                                                              onPressed:
                                                                  () async {
                                                                logFirebaseEvent(
                                                                    'STATUS_PAGAMENTO_P_I_X_ALCANCE5DIAS_cont');
                                                                logFirebaseEvent(
                                                ...
                                                Stack(
                                                  children: [
                                                    if (ObterPagamentoPagarMECall
                                                            .statusPedido(
                                                          statusPagamentoPIXAlcance5diasObterPagamentoPagarMEResponse
                                                              .jsonBody,
                                                        ) ==
                                                        'pending')
                                                      Row(
                                        ...
                                        Expanded(
                                          child: Padding(
                                            ...
                                            child: FFButtonWidget(
                                              onPressed: () async {
                                                logFirebaseEvent(
                                                    'STATUS_PAGAMENTO_P_I_X_ALCANCE5DIAS_ATUA');
                                                logFirebaseEvent(
                                        ...
                                        if (ObterPagamentoPagarMECall
                                          ...
                                          Padding(
                                            ...
                                            child: FFButtonWidget(
                                              onPressed: () async {
                                                logFirebaseEvent(
                                                    'STATUS_PAGAMENTO_P_I_X_ALCANCE5DIAS_VOLT');
                                                logFirebaseEvent(
                                                    'Button_backend_call');
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            child: FFButtonWidget(
                                              onPressed: () async {
                                                logFirebaseEvent(
                                                    'STATUS_PAGAMENTO_P_I_X_ALCANCE5DIAS_IR_P');
                                                logFirebaseEvent(
                                                    'Button_backend_call');
