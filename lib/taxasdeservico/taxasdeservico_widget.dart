...
import 'taxasdeservico_model.dart';
export 'taxasdeservico_model.dart';

class TaxasdeservicoWidget extends StatefulWidget {
  const TaxasdeservicoWidget({super.key});

  static String routeName = 'taxasdeservico';
  static String routePath = 'taxasdeservico';

  @override
  State<TaxasdeservicoWidget> createState() => _TaxasdeservicoWidgetState();
}

class _TaxasdeservicoWidgetState extends State<TaxasdeservicoWidget> {
  late TaxasdeservicoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TaxasdeservicoModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'taxasdeservico'});
              ...
              headerSliverBuilder: (context, _) => [
                SliverAppBar(
                  ...
                  leading: FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      logFirebaseEvent(
                          'TAXASDESERVICO_arrow_back_rounded_ICN_ON');
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Expanded(
                                    child: Text(
                                      'Taxa padrão de serviço (9%): R\$10,00',
                                      textAlign: TextAlign.center,
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Expanded(
                                    child: Text(
                                      'Taxa de aumento de alcance: R\$5,00 (exemplo)',
                                      textAlign: TextAlign.center,
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
