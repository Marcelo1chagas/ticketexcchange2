...
import 'status_pagamento_p_i_x_alcance1dia30_o_f_f_model.dart';
export 'status_pagamento_p_i_x_alcance1dia30_o_f_f_model.dart';

class StatusPagamentoPIXAlcance1dia30OFFWidget extends StatefulWidget {
  const StatusPagamentoPIXAlcance1dia30OFFWidget({
    super.key,
  ...
  static String routeName = 'statusPagamentoPIXAlcance1dia30OFF';
  static String routePath = 'statusPagamentoPIXAlcance1dia30OFF';

  @override
  State<StatusPagamentoPIXAlcance1dia30OFFWidget> createState() =>
      _StatusPagamentoPIXAlcance1dia30OFFWidgetState();
}

class _StatusPagamentoPIXAlcance1dia30OFFWidgetState
    extends State<StatusPagamentoPIXAlcance1dia30OFFWidget> {
  late StatusPagamentoPIXAlcance1dia30OFFModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => StatusPagamentoPIXAlcance1dia30OFFModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'statusPagamentoPIXAlcance1dia30OFF'});
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final statusPagamentoPIXAlcance1dia30OFFObterPagamentoPagarMEResponse =
            snapshot.data!;
                                                      ...
                                                      children: [
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: InkWell(
                                                            ...
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'STATUS_PAGAMENTO_P_I_X_ALCANCE1DIA30_O_F');
                                                              logFirebaseEvent(
                                                      ...
                                                      Stack(
                                                        children: [
                                                          if (ObterPagamentoPagarMECall
                                                                  .statusPedido(
                                                                statusPagamentoPIXAlcance1dia30OFFObterPagamentoPagarMEResponse
                                                                    .jsonBody,
                                                              ) ==
                                                              'pending')
                                                            Row(
