                                          ...
                                          Row(
                                            ...
                                            children: [
                                              InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'SUPORTEAOCLIENTE_Container_khkklwkv_ON_T');
                                                  logFirebaseEvent(
                                              ...
                                              Material(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'SUPORTEAOCLIENTE_Icon_cymqxbco_ON_TAP');
                                                      logFirebaseEvent(
                                                          'Icon_launch_u_r_l');
                                                      await launchURL(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                              ...
                                              children: [
                                                ...
                                                Padding(
                                                  ...
                                                  child: TextFormField(
                                                    ...
                                                    decoration: InputDecoration(
                                                      hintText:
                                                          'Forneça detalhes sobre o problema que você está enfrentando',
                                                      hintStyle:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                              .bodyMedium
                                                    ...
                                                    if (_model.uploadedFileUrl ==
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: InkWell(
                                                          ...
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'SUPORTEAOCLIENTE_Container_ik9n9x7y_ON_T');
                                                            logFirebaseEvent(
                                            ...
                                            FFButtonWidget(
                                              onPressed: () async {
                                                logFirebaseEvent(
                                                    'SUPORTEAOCLIENTE_PAGE_ENVIAR_BTN_ON_TAP');
                                                logFirebaseEvent(
                                                ...
                                                await MensagensSuporteRecord
                                                    .collection
                                                    .doc()
                                                    .set(
                                                        createMensagensSuporteRecordData(
                                                      nomedousuario:
                                                          valueOrDefault(
                                                              currentUserDocument
                                                                  ?.name,
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'SUPORTEAOCLIENTE_Text_vpft46is_ON_TAP');
                                                logFirebaseEvent(
                                                    'Text_navigate_to');

                                                context.pushNamed(
                                                    PoliticasdoappWidget
                                                        .routeName);
                                              },
                                              child: Text(
                    ...
                    Align(
                      ...
                      child: Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(
                            24.0, 8.0, 24.0, 0.0),
                        child: Text(
                          'Os dois canais oficias para nosso suporte,  funcionam de:',
                          style: FlutterFlowTheme.of(context)
                              .bodyMedium
                              .override(
                                fontFamily: FlutterFlowTheme.of(context)
                    ...
                    Align(
                      ...
                      child: Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(
                            24.0, 8.0, 7.0, 30.0),
                        child: Text(
                          'Segunda à Quinta - Horário Comercial\nA partir das 8:00 às 20:00\n\nSexta e Sabádo -\nA partir das 8 às 00:00',
                          style:
