...
import 'criarconta_n_o_v_a_model.dart';
export 'criarconta_n_o_v_a_model.dart';

class CriarcontaNOVAWidget extends StatefulWidget {
  const CriarcontaNOVAWidget({super.key});

  static String routeName = 'criarcontaNOVA';
  static String routePath = 'criarcontaNOVA';

  @override
  State<CriarcontaNOVAWidget> createState() => _CriarcontaNOVAWidgetState();
}

class _CriarcontaNOVAWidgetState extends State<CriarcontaNOVAWidget>
    with TickerProviderStateMixin {
  late CriarcontaNOVAModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CriarcontaNOVAModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'criarcontaNOVA'});
    ...
    _model.dddTextController ??= TextEditingController();
    _model.dddFocusNode ??= FocusNode();
                      ...
                      child: Column(
                        ...
                        children: [
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                      ...
                                      children: [
                                        Container(
                                          ...
                                          child: Padding(
                                            ...
                                            child: TextFormField(
                                              controller:
                                                  _model.dddTextController,
                                              focusNode: _model.dddFocusNode,
                                              autofocus: false,
                                              obscureText: false,
                                              decoration: InputDecoration(
                                                labelText: 'DDD',
                                              ...
                                              validator: _model
                                                  .dddTextControllerValidator
                                                  .asValidator(context),
                                              inputFormatters: [_model.dddMask],
                                            ),
                                          ),
                                        ),
                                        Expanded(
                                    ...
                                    TextFormField(
                                      controller:
                                          _model.datadenascimentoTextController,
                                      focusNode:
                                          _model.datadenascimentoFocusNode,
                                      autofocus: false,
                                      obscureText: false,
                                      decoration: InputDecoration(
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'CRIARCONTA_N_O_V_A_CRIAR_CONTA_BTN_ON_TA');
                              ...
                              _model.sucessoCliente1 =
                                  await CriarClientePagarMECall.call(
                                name: _model.nomeTextController.text,
                                email: _model.emailTextController.text,
                                document: _model.cpfTextController.text,
                                documentType: 'CPF',
                                code:
                                    '25${random_data.randomInteger(40, 180).toString()}',
                                type: 'individual',
                                country: 'BR',
                                state: _model.ufTextController.text,
                                city: _model.cidadeTextController.text,
                                zipCode: _model.cepTextController.text,
                                line1: _model.enderecoTextController.text,
                                countryCode: '55',
                                areaCode: _model.dddTextController.text,
                                number: _model.celularTextController.text,
                              );

                              _shouldSetState = true;
                              if ((_model.sucessoCliente1?.succeeded ?? true)) {
                                ...
                                await UsersRecord.collection
                                  ...
                                  ...createUsersRecordData(
                                    ...
                                    datadenascimento: _model
                                        .datadenascimentoTextController.text,
                                    image: '',
                                    likes: 0,
                                    idClientePagarME:
                                        CriarClientePagarMECall.idCliente(
                                      (_model.sucessoCliente1?.jsonBody ?? ''),
                                    ),
                                    idClienteCobrancaPagarME:
                                        CriarClientePagarMECall.idEndereco(
                                      (_model.sucessoCliente1?.jsonBody ?? ''),
                                    ),
                                    ...
                                    cidadeFortaleza:
                                        _model.cidadeTextController.text ==
                                            'Fortaleza',
                                    codePagarME:
                                        CriarClientePagarMECall.codePagarME(
                                      (_model.sucessoCliente1?.jsonBody ?? ''),
                                    ),
                                    cidadeNovaLima:
                                        (_model.cidadeTextController.text ==
                                    ...
                                    cidadeBetim:
                                        (_model.cidadeTextController.text ==
                                            ...
                                            (_model.cidadeTextController.text ==
                                                'Betim '),
                                    phoneNumber:
                                        '${_model.dddTextController.text} ${_model.celularTextController.text}',
                                    fotosTrue: false,
                                  ),
                                  ...mapToFirestore(
                                    {
                                ...
                                logFirebaseEvent('Button_backend_call');
                                await BFEmailbemvindo2804Group
                                    .emailbemvindo2804Call
                                    .call(
                                  to: _model.emailTextController.text,
                                  subject: 'Bem Vindo  ao Ticket Exchange 💙🩷',
                                  name: _model.nomeTextController.text,
                                );
                                ...
                                triggerPushNotification(
                                  notificationTitle: '❤️ Bem vindo!',
                                  notificationText:
                                      'Começe a vendar agora! Esperamos que sua experiência seja incrível!',
                                  notificationSound: 'default',
                                  userRefs: [currentUserReference!],
                                  initialPageName: 'AdicionarIngresso',
                                  parameterData: {},
                                );
                                logFirebaseEvent('Button_navigate_to');

                                context.pushNamedAuth(
                                  TemaPageInicialWidget.routeName,
                                  context.mounted,
                                  queryParameters: {
                                ...
                                await showDialog(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      title: Text('erro'),
                                      content: Text(CriarClientePagarMECall
                                          .mensagemdeERRO(
                                        (_model.sucessoCliente1?.jsonBody ??
                                            ''),
                                      ).toString()),
                            ...
                            children: [
                              isAndroid
                                  ...
                                  : FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'CRIARCONTA_N_O_V_A_PAGE_APPLE_BTN_ON_TAP');
                                        logFirebaseEvent('Button_auth');
                                        GoRouter.of(context).prepareAuthEvent();
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'CRIARCONTA_N_O_V_A_FACEBOOK_BTN_ON_TAP');
                                  logFirebaseEvent('Button_auth');
                                  GoRouter.of(context).prepareAuthEvent();
                                  final user = await authManager
                          ...
                          InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'CRIARCONTA_N_O_V_A_Row_9hx6kwkp_ON_TAP');
                            ...
                            child: Row(
                              ...
                              children: [
                                InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'CRIARCONTA_N_O_V_A_RichText_8a21qj25_ON_');
                                    logFirebaseEvent('RichText_navigate_to');

                                    context
                                        .pushNamed(LoginNOVOWidget.routeName);
                                  },
                                  child: RichText(
                                    textScaler:
