...
import 'polticadecompraeenvio_model.dart';
export 'polticadecompraeenvio_model.dart';

class PolticadecompraeenvioWidget extends StatefulWidget {
  const PolticadecompraeenvioWidget({super.key});

  static String routeName = 'polticadecompraeenvio';
  static String routePath = 'polticadecompraeenvio';

  @override
  State<PolticadecompraeenvioWidget> createState() =>
      _PolticadecompraeenvioWidgetState();
}

class _PolticadecompraeenvioWidgetState
    extends State<PolticadecompraeenvioWidget> {
  late PolticadecompraeenvioModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PolticadecompraeenvioModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'polticadecompraeenvio'});
  ...
  Widget build(BuildContext context) {
    return Title(
        title: 'Política de Compra e Envio',
              ...
              headerSliverBuilder: (context, _) => [
                SliverAppBar(
                  ...
                  leading: FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      logFirebaseEvent(
                          'POLTICADECOMPRAEENVIO_arrow_back_rounded');
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Expanded(
                                    child: Text(
                                      '3 - Investigação em Caso de Atraso:',
                                      textAlign: TextAlign.center,
                                      style: FlutterFlowTheme.of(context)
                                          .headlineSmall
                                          .override(
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Expanded(
                                    child: Text(
                                      '4 - Devolução do Dinheiro em caso de não envio:',
                                      textAlign: TextAlign.center,
                                      style: FlutterFlowTheme.of(context)
                                          .headlineSmall
                                          .override(
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Expanded(
                                    child: Text(
                                      '6 - Informações de Contato Atualizadas:',
                                      textAlign: TextAlign.center,
                                      style: FlutterFlowTheme.of(context)
                                          .headlineSmall
                                          .override(
