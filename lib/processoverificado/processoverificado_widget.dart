...
import 'processoverificado_model.dart';
export 'processoverificado_model.dart';

class ProcessoverificadoWidget extends StatefulWidget {
  const ProcessoverificadoWidget({super.key});

  static String routeName = 'processoverificado';
  static String routePath = 'processoverificado';

  @override
  State<ProcessoverificadoWidget> createState() =>
      _ProcessoverificadoWidgetState();
}

class _ProcessoverificadoWidgetState extends State<ProcessoverificadoWidget> {
  late ProcessoverificadoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProcessoverificadoModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'processoverificado'});
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              leading: FlutterFlowIconButton(
                ...
                onPressed: () async {
                  logFirebaseEvent('PROCESSOVERIFICADO_arrow_back_rounded_IC');
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'PROCESSOVERIFICADO_COMPRAR_BTN_ON_TAP');
                              logFirebaseEvent('Button_navigate_to');

                              context
                                  .pushNamed(ComprarverificadoWidget.routeName);
                            },
                            text: 'Comprar',
                    ...
                    Padding(
                      ...
                      child: Text(
                        'Processo de verificação de perfil do Ticket Exchange',
                        style: FlutterFlowTheme.of(context)
                            .headlineMedium
                            .override(
                              fontFamily: FlutterFlowTheme.of(context)
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'PROCESSOVERIFICADO_INICIAR_PROCESSO_DE_V');
                                  logFirebaseEvent('Button_navigate_to');

                                  context.pushNamed(
                                      ComprarverificadoWidget.routeName);
                                },
                                text: 'Iniciar Processo de Verificação',
                                icon: Icon(
                                  Icons.verified_sharp,
                                  size: 15.0,
                                ),
