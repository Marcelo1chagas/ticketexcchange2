              ...
              headerSliverBuilder: (context, _) => [
                SliverAppBar(
                  ...
                  leading: FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      logFirebaseEvent(
                          'POLITICADEDEVOLUCAO_arrow_back_rounded_I');
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Expanded(
                                    child: Text(
                                      '1- Devolução Integral em caso de não envio:',
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Expanded(
                                    child: Text(
                                      '2- Envio do Ingresso após confirmação do pagamento:',
                                      textAlign: TextAlign.center,
                                      style: FlutterFlowTheme.of(context)
                                          .headlineSmall
                                          .override(
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Expanded(
                                    child: Text(
                                      '3- Notificação de confirmação de envio:',
                                      textAlign: TextAlign.center,
                                      style: FlutterFlowTheme.of(context)
                                          .headlineSmall
                                          .override(
                                  ...
                                  Expanded(
                                    child: Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'POLITICADEDEVOLUCAO_WHATS_A_P_P_BTN_ON_T');
                                          logFirebaseEvent(
                                              'Button_launch_u_r_l');
                                          await launchURL(
                                  ...
                                  Expanded(
                                    child: Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'POLITICADEDEVOLUCAO_E_MAIL_BTN_ON_TAP');
                                          logFirebaseEvent(
                                              'Button_launch_u_r_l');
                                          await launchURL(
